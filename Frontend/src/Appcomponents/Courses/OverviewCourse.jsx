      ...
      {overview && (
        <div>
          <div className="bg-pale py-12 rounded-lg shadow-lg w-full flex flex-col items-center justify-center">
            <div className="w-full max-w-[90%] md:max-w-[80%] grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Course Details */}
              <div className="p-4 order-2 md:order-1 flex flex-col items-center justify-center text-center md:items-start">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 w-full">
                  <h2 className="text-3xl font-semibold text-heading text-center md:text-left">
                ...
                <p className="my-3 text-base text-gray-700 font-semibold text-center md:text-left">
              ...
              {/* Video Section */}
              <div className="order-1 md:order-2 sm:p-4 flex justify-center">
                <HeroVideoDialog
          ...
          <div className="w-[95%] max-w-[80%] mx-auto my-10">
          ...
          <div className="flex flex-col lg:flex-row w-[95%] max-w-[80%] mx-auto justify-between my-10 gap-4">
            <div className="w-full lg:w-1/2">
              <h1 className="text-xl font-semibold mb-5">What You'll Learn</h1>
              <div className="flex-1 h-auto overflow-y-auto bg-pale p-12 rounded-lg flex flex-col gap-3 items-center justify-center text-center">
                <div dangerouslySetInnerHTML={{ __html: overview?.overview }} />
              </div>
            ...
            {/* Course Accordian */}
            <div className="relative flex-1 flex-col gap-2 w-full lg:w-1/2 mx-auto">
