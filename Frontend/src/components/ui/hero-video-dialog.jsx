...
export default function HeroVideoDialog({
  ...
  return (
    ...
    {/* Thumbnail */}
    <div
      className="group relative cursor-pointer max-w-md mx-auto"
      ...
      <div
        ...
        <div
          className="flex size-20 items-center justify-center rounded-full bg-primary/10 backdrop-blur-md">
          <div
            className="relative flex size-14 scale-100 items-center justify-center rounded-full bg-gradient-to-b from-primary/30 to-primary shadow-md transition-all duration-200 ease-out group-hover:scale-[1.2]">
            <Play
      ...
      {isVideoOpen && (
        <motion.div
          ...
          <motion.div
            ...
            className="relative mx-4 aspect-video w-full max-w-lg md:mx-0"> {/* Reduced max width */}
            <motion.button
